...
EXTERN char *vFormatString(const char *Format,
                           va_list     Arguments);
EXTERN char *FormatString(TranslatedString_pa Format,
                          ...); /* 0 or more variable arguments */
EXTERN char *DupString(TranslatedString_pa String);
...
#ifndef MSWIN
EXTERN void LowerCaseStr(char *s);
#endif
...
EXTERN Boolean_t ScanForString(const char **SourceStream,
                               char       **DestString,
...
EXTERN Boolean_t EscapeOutDelimitersInString(char **S,
                                             char Delimiter);
EXTERN Boolean_t ScanForSymbol(const char **CPtr,
                               char       Symbol,
