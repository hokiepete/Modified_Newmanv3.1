                                          ...
                                          ArbParam_t ClientData)
{
  ...
  if (*SourceStringRef != NULL)
    IsOk = ((*TargetStringRef = DupString(_nts(*SourceStringRef))) != NULL);
  else
                                   ...
                                   LgIndex_t     StringOffset)
{
  ...
  if (StringRef == NULL)
    ...
    Result = DupString(_nts(StringRef));
                              ...
                              const char   *String)
{
  ...
  if (String != NULL)
    {
      ItemCopy.CharPtr = DupString(_nts(String));
  ...
  if (IsOk)
    {
      ...
      ArrayListDealloc((ArrayList_pa *)&SourceCopy, NULL, 0);
    }
                                  ...
                                  char       **NextSubString)
{
  ...
  *NextSubString = NULL;
  ...
  if (IsOk && (CStart != CPtr))
    {
      short StrLen = (short)(CPtr-CStart);
                    ...
                    ArbParam_t                    ClientData)
{
  ...
  ArrayListSort((ArrayList_pa)StringList, ComparatorProxy, ClientData);
