...
#if defined TECPLOTKERNEL && defined MS_UNICODE
/* CORE SOURCE CODE REMOVED */
#else
...
#if defined VMS
#  define LARGESTDOUBLEEXPONENT  307
#  define SMALLESTDOUBLEEXPONENT -307
#  define LARGESTDOUBLE          1.0e+307
#  define LARGEFLOAT             1.0e+37
#  define SMALLFLOAT             1.0e-37
#else
...
#define TecplotBinaryFileVersion    108   /* NOTE: MUST also change this define symbol in preplot.c */
#define TecplotInterfaceVersion     110
#define TecplotInterfaceVersionStr  "110" /* stay in lockstep with TecplotInterfaceVersion */
#define TecplotLicenseVersion       110   /* may vary from TecplotInterfaceVersion */

#define    MAXASCIICOMMANDLENGTH     120000
...
#define    MaxIsoSurfaceGroups       4
#define    MaxSliceGroups            4

#define    MaxColorMapGroups         4
...
/*
 * Destination for all rendering (VDI/Gr) functions.
 */
typedef enum
  {
 ...
 * Render desitiation callback responsible for switching the render
 * desitination of the OpenGL drawing state when requested by the Tecplot
 * engine.
 *
 * @since
 *   11.0-0-397
 *
 * @param RenderDest
 *   Enumeration of render destination of interest.
 * @param ClientData
 *   Client data that was registered with the callback.
 *
 * @sa TecEngRenderDestRegisterCallback
 */
typedef void (STDCALL *RenderDestCallback_pf)(RenderDest_e RenderDest,
                                              ArbParam_t   ClientData);

/* - NO DOXYGEN COMMENT GENERATION -
 * Render desitiation size callback responsible for returning the size of the
 * specified render desitination when requested by the Tecplot engine.
 *
 * @since
 *   11.0-0-397
 *
 ...
 */
typedef void (STDCALL *RenderDestSizeCallback_pf)(RenderDest_e  RenderDest,
                                                  ArbParam_t    ClientData,
                                                  LgIndex_t    *Width,
                                                  LgIndex_t    *Height);
 ...
 */
typedef void (STDCALL *SwapBuffersCallback_pf)(ArbParam_t ClientData);
 ...
 */
typedef void (STDCALL *KeyStateCallback_pf)(ArbParam_t  ClientData,
 ...
 */
typedef void (STDCALL *ProcessBusyEventsCallback_pf)(ArbParam_t  ClientData);
 ...
 */
typedef Boolean_t (STDCALL *DialogLaunchCallback_pf)(ArbParam_t ClientData);
 ...
 * @sa TecUtilDialogLaunch, TecUtilDialogDrop
 */
typedef void (STDCALL *DialogDropCallback_pf)(ArbParam_t ClientData);
 ...
 */
typedef void (STDCALL *DotPitchCallback_pf)(ArbParam_t  ClientData,
                                            double     *IDotsPerCm,
                                            double     *JDotsPerCm);
...
#else
#endif
#if defined MS_UNICODE && defined TECPLOTKERNEL
#endif
#if 0 /* NOTUSED */
#endif
#ifdef MSWIN
