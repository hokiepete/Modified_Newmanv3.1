 ...
 * zone deleted or inserted by the specified amount or invalidates the face
 * neighbor if it references the deleted zone.
 *
 * param DataSet
 ...
 */
EXTERN void FaceNeighborAdjustUserDefAfterZoneAdjustment(DataSet_s  *DataSet,
