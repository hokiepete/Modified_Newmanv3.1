 ...
 *****************************************************************
 *******                                                  ********
 ****** (C) Copyright 1989-2001  by AMTEC ENGINEERING INC.********
 *******       All Rights Reserved.                       ********
 *******                                                  ********
 *****************************************************************
 *****************************************************************
 ...
 * be expanded to accommodate the additonal item.  If the offset is beyond the
 ...
 */
void *ArrayListGetItemInternalRef_FUNC(ArrayList_pa ArrayList,
                                       LgIndex_t    ItemOffset)
{
  void *Result;
  ...
  Result = ArrayListGetItemInternalRef_MACRO(ArrayList, ItemOffset);
 ...
 *     pointer types the effiect is copy by reference.
 * param ClientData
 ...
 */
static int CompareItemsProxy(const void *Item1Ref,
                             const void *Item2Ref)
{
  int Result;
...
/**
 * Sorts the array list by repeatedly calling the 'Comparator' function until
 ...
 */
void ArrayListSort(ArrayList_pa                ArrayList,
                   ...
                   ArbParam_t                  ClientData)
{
  ...
  qsort(ArrayList->Array, ArrayList->Count,
        ArrayList->ItemSize, CompareItemsProxy);
...
/**
 * Searches a sorted array looking for a match using the supplied comparator
 * function. If a match is found the resulting item index refers to the
 * location otherwise it refers to the location where the item could be
 ...
 */
Boolean_t ArrayListSearch(ArrayList_pa                ArrayList,
                          ArrayListItem_u             Item,
                          ArrayListItemComparator_pf  Comparator,
                          ArbParam_t                  ClientData,
                          LgIndex_t                  *ItemIndex)
 ...
 */
void *ArrayListGetInternalRef_FUNC(ArrayList_pa ArrayList)
{
  void *Result;

  REQUIRE(ArrayListIsValid(ArrayList));

  Result = ArrayListGetInternalRef_MACRO(ArrayList);
