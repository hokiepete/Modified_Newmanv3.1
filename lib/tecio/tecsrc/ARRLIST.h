...
*****************************************************************
*******                                                  ********
****** (C) Copyright 1988-2004  by AMTEC ENGINEERING INC. *******
*******                                                  ********
*****************************************************************
*****************************************************************
*/
 ...
 * @param ClientData
 *     Contextual information that was passed to the 'ArrayListSort' function.
 *
 * @return
...
EXTERN void ArrayListSort(ArrayList_pa               ArrayList,
                          ArrayListItemComparator_pf Comparator,
                          ArbParam_t                 ClientData);
EXTERN Boolean_t ArrayListSearch(ArrayList_pa                ArrayList,
                                 ArrayListItem_u             Item,
                                 ArrayListItemComparator_pf  Comparator,
                                 ArbParam_t                  ClientData,
                                 LgIndex_t                  *ItemIndex);
   ...
   /**
    * Gets a the array list's internal buffer representation.
...
#  define ArrayListGetUnsignedChar(ArrayList, ItemOffset)     ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned char)
#  define ArrayListGetUnsignedShort(ArrayList, ItemOffset)    ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned short)
#  define ArrayListGetUnsignedInt(ArrayList, ItemOffset)      ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned int)
#  define ArrayListGetUnsignedLong(ArrayList, ItemOffset)     ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned long)
#  define ArrayListGetInt64(ArrayList, ItemOffset)            ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, Int64_t)
#  define ArrayListGetChar(ArrayList, ItemOffset)             ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, char)
#  define ArrayListGetShort(ArrayList, ItemOffset)            ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, short)
#  define ArrayListGetInt(ArrayList, ItemOffset)              ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, int)
#  define ArrayListGetLong(ArrayList, ItemOffset)             ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, long)
#  define ArrayListGetFloat(ArrayList, ItemOffset)            ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, float)
#  define ArrayListGetDouble(ArrayList, ItemOffset)           ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, double)
#  define ArrayListGetLgIndex(ArrayList, ItemOffset)          ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, LgIndex_t)
#  define ArrayListGetEntIndex(ArrayList, ItemOffset)         ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, EntIndex_t)
#  define ArrayListGetSmInteger(ArrayList, ItemOffset)        ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, SmInteger_t)
#  define ArrayListGetBoolean(ArrayList, ItemOffset)          ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, Boolean_t)
#  define ArrayListGetArbParam(ArrayList, ItemOffset)         ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, ArbParam_t)
#  define ArrayListGetUnsignedCharPtr(ArrayList, ItemOffset)  ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned char *)
#  define ArrayListGetUnsignedShortPtr(ArrayList, ItemOffset) ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned short *)
#  define ArrayListGetUnsignedIntPtr(ArrayList, ItemOffset)   ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned int *)
#  define ArrayListGetUnsignedLongPtr(ArrayList, ItemOffset)  ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, unsigned long *)
#  define ArrayListGetInt64Ptr(ArrayList, ItemOffset)         ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, Int64_t *)
#  define ArrayListGetCharPtr(ArrayList, ItemOffset)          ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, char *)
#  define ArrayListGetShortPtr(ArrayList, ItemOffset)         ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, short *)
#  define ArrayListGetIntPtr(ArrayList, ItemOffset)           ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, int *)
#  define ArrayListGetLongPtr(ArrayList, ItemOffset)          ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, long *)
#  define ArrayListGetFloatPtr(ArrayList, ItemOffset)         ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, float *)
#  define ArrayListGetDoublePtr(ArrayList, ItemOffset)        ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, double *)
#  define ArrayListGetLgIndexPtr(ArrayList, ItemOffset)       ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, LgIndex_t *)
#  define ArrayListGetEntIndexPtr(ArrayList, ItemOffset)      ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, EntIndex_t *)
#  define ArrayListGetSmIntegerPtr(ArrayList, ItemOffset)     ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, SmInteger_t *)
#  define ArrayListGetBooleanPtr(ArrayList, ItemOffset)       ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, Boolean_t *)
#  define ArrayListGetArbParamPtr(ArrayList, ItemOffset)      ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, ArbParam_t *)
#  define ArrayListGetVoidPtr(ArrayList, ItemOffset)          ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, void *)
#  define ArrayListGetFunctionPtr(ArrayList, ItemOffset)      ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, (**)(void))
#else
...
#if !defined USE_MACROS_FOR_FUNCTIONS
  EXTERN void *ArrayListGetInternalRef_FUNC(ArrayList_pa ArrayList);
  EXTERN void *ArrayListGetItemInternalRef_FUNC(ArrayList_pa ArrayList,
                                                LgIndex_t    ItemOffset);
  EXTERN LgIndex_t ArrayListGetCount_FUNC(ArrayList_pa ArrayList);
#endif

#define ArrayListGetInternalRef_MACRO(ArrayList)                       ((void *)((ArrayList)->Array))
#define ArrayListGetItemInternalRef_MACRO(ArrayList, ItemOffset)       ((void *)&((ArrayList)->Array[(ItemOffset)*(ArrayList)->ItemSize]))
#define ArrayListGetCount_MACRO(ArrayList)                             ((ArrayList)->Count)
#define ArrayListGetTypedItem_MACRO(ArrayList, ItemOffset, NativeType) (((NativeType *)((ArrayList)->Array))[ItemOffset])
 ...
 * array list of a known type. The only additonal overhead incurred versus just
...
/**
 * This section provides macros for high speed setting of an item to an array list
 * of a known type. The only additional overhead incurr
 */
#endif /* ARRLIST_h */
