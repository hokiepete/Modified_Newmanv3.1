...
void GetCodedVelocity(double t, double *X, double *dXdt) {
	...
	//Glider
	/*xdot = sqrt(x^2 + y^2)*( -y*( 1.2*sin(-2*atan2(y,x)) ) - (1.4-cos(-2*atan2(y,x)))*x )
	ydot = sqrt(x^2 + y^2)*( x*( 1.2*sin(-2*atan2(y,x)) ) - (1.4-cos(-2*atan2(y,x)))*y) - 1*/

	//dXdt[0]=sqrt(pow(X[0],2.0) + pow(X[1],2.0))*( -X[1]*( 1.2*sin(-2*atan2(X[1],X[0])) ) - (1.4-cos(-2*atan2(X[1],X[0])))*X[0] );
	//dXdt[1]=sqrt(pow(X[0],2.0) + pow(X[1],2.0))*( X[0]*( 1.2*sin(-2*atan2(X[1],X[0])) ) - (1.4-cos(-2*atan2(X[1],X[0])))*X[1]) - 1;
